...
import java.util.List; // Vi phạm: Wildcard import
...
public class Bank {
    ...
    public void saveReport(String folderName) {
    // Tự động xử lý dấu gạch chéo dựa trên OS
    Path path = Paths.get(folderName, "report.txt");
